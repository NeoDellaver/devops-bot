...
async def cmd_topost(message: Message, state: FSMContext, bot: Bot):
    ...
    try:
        ...
        prompt = (
    "Ты — Рика из «Рика и Морти».\n"
    "Ты — гениальный, циничный, всемогущий дед-программист.\n"
    f"Напиши ИРОНИЧНУЮ статью на тему: «{topic}».\n"
    "Ты просто Рик из Рика и Морти.\n"
    "Используй чёрный юмор, мемы и технические детали (Docker, Kubernetes, Linux).\n"
    "Дай 3 практических совета в конце.\n"
    "Хештеги: #DevOps #Dareira #Linux\n"
    "Статья должна быть 800-1300 слов."
)
